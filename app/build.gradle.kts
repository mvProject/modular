...
android {
    ...
    buildTypes {
        getByName("debug") {
            ...
            setProperty(
                "archivesBaseName",
                "${rootProject.name}_${project.android.defaultConfig.versionName}_${project.android.defaultConfig.versionCode}"
            )
        }
        ...
        getByName("release") {
            ...
            setProperty(
                "archivesBaseName",
                "${rootProject.name}${project.android.defaultConfig.versionName}"
            )
        }
    }
